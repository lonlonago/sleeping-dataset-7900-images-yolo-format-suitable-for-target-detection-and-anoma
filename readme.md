# Sleeping Dataset 7900 images YOLO format suitable for target detection and anomaly behavior.

# Body

Sleeping Detection Dataset, 7900 images in YOLO format, suitable for target detection, anomaly behavior detection, computer vision research. The data is clear and labeled completely, ready to use directly, saving time and effort
